...
banksel TRISC
bcf TRISC, 0 ;Pin ((PORTC) and 07Fh), 0 configured as output
bcf TRISC, 1 ;Pin ((PORTC) and 07Fh), 1 configured as output
bcf TRISC, 2 ;Pin ((PORTC) and 07Fh), 2 configured as output
bcf TRISC, 3 ;Pin ((PORTC) and 07Fh), 3 configured as output
bsf TRISC, 4 ;Pin ((PORTC) and 07Fh), 4 configured as input
bsf TRISC, 5 ;Pin ((PORTC) and 07Fh), 5 configured as input
...
bcf TRISD, 2 ;Pin ((PORTD) and 07Fh), 2 configured as output
bcf TRISD, 3 ;Pin ((PORTD) and 07Fh), 3 configured as output
